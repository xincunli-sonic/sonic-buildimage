...
# Tests import config/main.py which uses click>=8.0 features (shell_complete),
# incompatible with the click==7.0 pin in setup.py. Skip until resolved upstream.
$(SONIC_GCU_PY3)_TEST = n
